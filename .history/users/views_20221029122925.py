...
def trainees(request):
    ...
    if request.method == "POST":
        ...
        date_of_training = request.POST["date_of_training"]
        idea = request.POST["idea"]
        institution = request.POST["institution"]
        qualification = request.POST["qualification"]

        data = Trainee(nm=name, em=email, ag=age, ge=gender, date_of_training=date_of_training,
                       idea=idea, institution=institution, qualification=qualification)
